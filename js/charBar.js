function createChartBar(){
    ...
    let formL_1="<h5>Zaznacz czy chcesz skalę logarytmiczną" +
        ...
        "<input type=\"button\" value=\"Narysuj\" class=\"btn btn-primary\" onclick=\"plotChartBar()\">";
...
function plotChartBar() {
    ...
    drawCharBar(canvas_1, makeArrayValue(), makeName(), readColor(), makeLabels(),readTitle(),readLogarithm());
...
function drawCharBar(canvasBar,arrayValue,arrayName,arrayColor,labels,title,yLogarithmic) {
